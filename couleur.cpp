...
uint8_t muterconstant(uint8_t v, double amplitude)
{
      int val=v;
...
void Couleur::muterConstant(double amplitude)
{
    m_rouge = muterconstant(m_rouge, amplitude);
    m_vert = muterconstant(m_vert, amplitude);
    m_bleu = muterconstant(m_bleu, amplitude);
}
